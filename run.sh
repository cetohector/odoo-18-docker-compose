...
git clone --depth=1 https://github.com/cetohector/odoo-18-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: hootei.cloud.2332 | Live chat port: $CHAT"